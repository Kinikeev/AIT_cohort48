package home_work_29.car_garage_2.test;

import home_work_29.car_garage_2.dao.Garage_2;
import home_work_29.car_garage_2.dao.GarageImpl;
...
class GarageCopyImplTest {
    ...
    @Test
    void removeCar() {
        Car carVictim = garage.remove("Number_6");
        assertEquals(cars[2],garage.remove("Number_3"));
        assertNull(carVictim);
