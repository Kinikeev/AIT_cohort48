package class_work_16.computor_shop;

import class_work_16.computor_shop.model.Computer;
import class_work_16.computor_shop.model.Laptop;
import class_work_16.computor_shop.model.SmartPhon;
...
public class ComputerShopAppl {
    public static void main(String[] args) {
        ...
        computers[3] = new Laptop("M2",16,1024,"Apple",3000,14.1,10,2.6);
        computers[4] = new Laptop("M1",8,412,"Apple",2400,12.1,12,1.6);
        computers[5] = new Laptop("M3",32,2048,"Apple MacBook pro",5200,16,16,3.6);
