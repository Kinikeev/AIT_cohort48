package class_work_37.long_sentence;
...
public class LongSentence {
    ...
    public static void main(String[] args) {
        ...
        String sentence = "В 1800-х годах, в те времена, когда не было еще ни железных, ни шоссейных дорог, " +
                ...
                "и из другого угла комнаты бросались поднимать нечаянно и не нечаянно уроненные платочки, наши матери " +
                "носили коротенькие талии и огромные рукава и решали семейные дела выниманием билетиков, " +
        ...
        System.out.println("Number of unique words in sentence: " + uniqueWords.size());
    }
}
