...
public class DekanatAppl {
    ...
    public static void main(String[] args) {
        ...
        List<Student> sortedByLastName = studentList.stream().sorted( Comparator.comparing( Student::getLastName ) ).toList();
        ...
        List<Student> sortedByBirthDate = studentList.stream().sorted( Student.birthdayComparator ).toList();
