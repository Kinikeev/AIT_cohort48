...
class CompanyImplTest {
    ...
    void setUp() {
        ...
        firma[2] = new SalesManager(3000, "Peter", "Jackson", 160, 19000, 0.1, 50);
        firma[3] = new SalesManager(4000, "Robin", "Good", 180, 20000, 0.1, 45);
    ...
    @Test
    void totalSalary() {
        assertEquals(809215.0, company.totalSalary());
    }

    @Test
    void totalSales() {
        assertEquals(468000.0, company.totalSales());
    }
