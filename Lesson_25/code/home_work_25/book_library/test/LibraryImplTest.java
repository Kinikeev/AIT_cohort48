package home_work_25.book_library.test;

import home_work_25.book_library.dao.Library;
import home_work_25.book_library.dao.LibraryImpl;
...
class LibraryImplTest {
    ...
    void setUp() {
        ...
        books[1] = new Book(200,"Title_2","Author_A",2002);
        books[2] = new Book(300,"Title_3","Author_C",2003);
        books[3] = new Book(400,"Title_4","Author_D",2004);
        books[4] = new Book(500,"Title_5","Author_A",2005);
    ...
    @Test
    void update() {
        Book book = new Book(400,"Title_10","Author_K",2023);
        assertEquals(books[3],library.update(book));
        book = new Book(700,"Title_10","Author_K",2023);
        assertNull(library.update(book));
    }
    ...
    void findAllBooksByAuthor() {
        Book[] expected = {books[0],books[1],books[4]};
        Book[] actual = library.findAllBooksByAuthor("Author_A");
        assertArrayEquals(expected,actual);
    }

    @Test
    void findBooksWithYearOfPublication() {
        Book[] expected = {books[1], books[2],books[3]};
        Book[] actual = library.findBooksWithYearOfPublication(2002,2004);
        assertArrayEquals(expected,actual);
    }
} // End of class